...
},{"./gsap-core.js":"../../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../../node_modules/gsap/CSSPlugin.js"}],"../script/barba.js":[function(require,module,exports) {
"use strict";
...
},{"@barba/core":"../../node_modules/@barba/core/dist/barba.umd.js","gsap":"../../node_modules/gsap/index.js"}],"../../node_modules/gsap/src/gsap-core.js":[function(require,module,exports) {
"use strict";
...
class Animation {
  ...
  totalTime(totalTime, suppressEvents) {
    ...
    if (this._tTime !== totalTime || !this._dur && !suppressEvents || this._initted && Math.abs(this._zTime) === _tinyNum || !totalTime && !this._initted && (this.add || this._ptLookup)) {
      ...
      _lazySafeRender(this, totalTime, suppressEvents); //   this._lock = 0;
      //}
...
exports.Power1 = Power1;
exports.Power0 = Power0;
},{}],"../../node_modules/gsap/src/CSSPlugin.js":[function(require,module,exports) {
"use strict";
...
_removeProperty = (target, property) => {
  ...
  let pt = new _gsapCore.PropTween(plugin._pt, target, property, 0, 1, onlySetAtEnd ? _renderNonTweeningValueOnlyAtEnd : _renderNonTweeningValue);
  plugin._pt = pt;
  pt.b = beginning;
  pt.e = end;
...
_convertToUnit = (target, property, value, unit) => {
  ...
  let pt = new _gsapCore.PropTween(this._pt, target.style, prop, 0, 1, _gsapCore._renderComplexString),
      index = 0,
      matchIndex = 0,
      a,
      result,
...
_specialProps = {
  clearProps(plugin, target, property, endValue, tween) {
    if (tween.data !== "isFromStart") {
      let pt = plugin._pt = new _gsapCore.PropTween(plugin._pt, target, property, 0, 0, _renderClearProps);
      pt.u = endValue;
      pt.pr = -10;
      pt.tween = tween;
...
_identity2DMatrix = [1, 0, 0, 1, 0, 0],
  ...
  let cache = target._gsap || (0, _gsapCore._getCache)(target),
      style = target.style,
      matrix = _getComputedTransformMatrixAsArray(target),
      parent,
      nextSibling,
  ...
  let cache = target._gsap || new _gsapCore.GSCache(target);
...
_addPxTranslate = (target, start, value) => {
  let unit = (0, _gsapCore.getUnit)(start);
  return (0, _gsapCore._round)(parseFloat(start) + parseFloat(_convertToUnit(target, "x", value + "px", unit))) + unit;
},
...
exports.checkPrefix = _checkPropPrefix;
exports._createElement = _createElement;
(0, _gsapCore._forEachName)("padding,margin,Width,Radius", (name, index) => {
  let t = "Top",
      r = "Right",
      b = "Bottom",
      l = "Left",
...
(function (positionAndScale, rotation, others, aliases) {
  let all = (0, _gsapCore._forEachName)(positionAndScale + "," + rotation + "," + others, name => {
    _transformProps[name] = 1;
  });
  (0, _gsapCore._forEachName)(rotation, name => {
    _gsapCore._config.units[name] = "deg";
    _rotationalProperties[name] = 1;
  });
  _propertyAliases[all[13]] = positionAndScale + "," + rotation;
  (0, _gsapCore._forEachName)(aliases, name => {
    let split = name.split(":");
    _propertyAliases[split[1]] = all[split[0]];
  });
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");

(0, _gsapCore._forEachName)("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", name => {
  _gsapCore._config.units[name] = "px";
});

_gsapCore.gsap.registerPlugin(CSSPlugin);
},{"./gsap-core.js":"../../node_modules/gsap/src/gsap-core.js"}],"../../node_modules/gsap/src/index.js":[function(require,module,exports) {
"use strict";
...
const gsapWithCSS = _gsapCore.gsap.registerPlugin(_CSSPlugin.CSSPlugin) || _gsapCore.gsap,
      // to protect from tree shaking
TweenMaxWithCSS = gsapWithCSS.core.Tween;

exports.TweenMax = TweenMaxWithCSS;
exports.default = exports.gsap = gsapWithCSS;
},{"./gsap-core.js":"../../node_modules/gsap/src/gsap-core.js","./CSSPlugin.js":"../../node_modules/gsap/src/CSSPlugin.js"}],"../script/menu.js":[function(require,module,exports) {
"use strict";

var _src = require("gsap/src");
...
var hamburger = document.querySelector(".header__menu-btn__burger");
var nav = document.querySelector(".header__navbar");
var menuNav = document.querySelector(".header__navbar__navlinks");
var navItems = document.querySelectorAll(".header__navbar__navlink");
var showMenu = false;
...
},{"gsap/src":"../../node_modules/gsap/src/index.js"}],"../script/homeFunction.js":[function(require,module,exports) {
var sliderContainer = document.querySelector(".main__home__slideContainer");
var slide = document.querySelector(".main__home__slides");
var upButton = document.querySelector(".up-button");
var downButton = document.querySelector(".down-button");
var paginate = document.querySelector(".paginate");
var slideLength = document.querySelectorAll(".main__home__slide").length;
var activeSlideIndex = 0;
var home = document.querySelector(".main__home");
...
var changeSlide = function changeSlide(direction) {
  ...
  slide.style.transform = "translateY(-".concat(activeSlideIndex * slideHeight, "px)");
  paginateCircle();
...
var paginateCircle = function paginateCircle() {
  paginate.innerHTML = "";

  for (var i = 0; i < slideLength; ++i) {
    paginate.innerHTML += "\n      <div class=\"circle\"\n      style = \"\n      ".concat(i === activeSlideIndex ? "\n        background-color: #c48f56;\n  \n        " : "\n        background-color: grey;\n  \n  \n        ", "\n      width: 10px;\n      height: 10px;\n      border-radius: 50%;\n      position: absolute;\n      right: 1%;\n      cursor: pointer;\n      top: ").concat(window.innerHeight / 2 - 20 * (slideLength - i) / 2 + i * 20 - 50, "px;\n      z-index = 10;\n      transition : 0.5s ease;\n  \n      \"/>\n      ");
  }

  var circles = document.querySelectorAll(".circle");

  var _loop = function _loop(_i) {
    circles[_i].addEventListener("click", function () {
      var slideHeight = sliderContainer.clientHeight;
      activeSlideIndex = _i;
      slide.style.transform = "translateY(-".concat(activeSlideIndex * slideHeight, "px)");
      slideLeft.style.transform = "translateY(".concat(activeSlideIndex * slideHeight, "px)");
      changeCircleColor();
    });
  };
...
var changeCircleColor = function changeCircleColor() {
  var circles = document.querySelectorAll(".circle");

  for (var i = 0; i < slideLength; ++i) {
    circles[i].style.backgroundColor = i === activeSlideIndex ? "#c48f56" : "grey";
...
require("./homeFunction");
},{"./barba":"../script/barba.js","./menu":"../script/menu.js","./homeFunction":"../script/homeFunction.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
